		  	...
		  	<div class="col-md-6">
                ...
                <div class="card-body">
                  ...
                  <tr role="row" class="odd">
                      ...
                      <td><a href="#" data-toggle="modal" data-target="#Modal<?= $usuarios_item['id']?>"><i class="fas fa-key"></i> Mudar Senha</a></td>
                      <td><a href="/admin/usuarios/excluir/<?= $usuarios_item['id']?>" onclick="return confirm('Deseja mesmo excluir o usuário <?= $usuarios_item['user']?> ?');"><i class="fas fa-trash"></i> Excluir</a></td>
                   </tr>
                   	
		<!-- Alterar Senha Modal-->
					  <div class="modal fade" id="Modal<?= $usuarios_item['id']?>" tabindex="-1" role="dialog" aria-hidden="true">
